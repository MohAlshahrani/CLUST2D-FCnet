...
% -------------------------------------------------------------------------------------------------
    ...
    opts.pairsPerVideoTrain =  10; % #has been changed avg number of pairs per training video (3862)
    opts.pairsPerVideoVal =  5; % #has been changed avg number of pairs per validation video (555)
    ...
    opts.train.numEpochs = 50; % EPOCHES #has been changed
    opts.train.learningRate = logspace_len(-2, -4, 50, opts.train.numEpochs);
    opts.train.weightDecay = 5e-4;
    opts.train.batchSize = 2; % we empirically observed that small batches work better
