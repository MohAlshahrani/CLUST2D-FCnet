...
% -------------------------------------------------------------------------------------------------------------------
    rootDataDir_src = [root_original 'dataset/CLUST2D/train/'];
    rootDataDir_dest = [root_crops 'crops/CLUST2D/train/'];
    ...
    for v=v_1:v_end
        ...
        for ti=1:numel(valid_trackids)
            ...
            for o = 1:numel(valid_objects)
                ...
                root = [rootDataDir_dest strrep(obj.frame_path,'.png','') '.' num2str(obj.track_id,'%02d')];
